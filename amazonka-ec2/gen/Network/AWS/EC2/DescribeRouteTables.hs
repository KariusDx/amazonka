...
--
-- For more information, see <http://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Route_Tables.html Route Tables> in the /Amazon Virtual Private Cloud User Guide/ .
--
--
...
--
-- * 'drtsNextToken' - The token to retrieve the next page of results.
--
...
--
-- * 'drtsMaxResults' - The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned __NextToken__ value. This value can be between 5 and 100.
--
...
-- | The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned __NextToken__ value. This value can be between 5 and 100.
drtsMaxResults :: Lens' DescribeRouteTables (Maybe Int)
drtsMaxResults = lens _drtsMaxResults (\ s a -> s{_drtsMaxResults = a})
