...
--
-- * 'stgrFilters' - One or more filters. The possible values are:     * @transit-gateway-route-destination-cidr-block@ - The CIDR range.     * @transit-gateway-route-state@ - The state of the route (@active@ | @blackhole@ ).     * @transit-gateway-route-transit-gateway-attachment-id@ - The ID of the attachment.     * @transit-gateway-route-type@ - The route type (@static@ | @propagated@ ).     * @transit-gateway-route-vpn-connection-id@ - The ID of the VPN connection.
searchTransitGatewayRoutes
